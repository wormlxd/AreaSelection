...
#define USER_INFO_CITY_NOTIFY               @"userInfoCityNotify"    //地区选择通知


@interface DistInfoViewController : UIViewController<UITableViewDataSource, UITableViewDelegate>
